...
#### Falta de conhecimento
	...
	Devido à falta de conhecimento em relação à tecnologia para captação de áudio do usuário, é possível que estoure o prazo de entrega da sprint que o requisito se encontra. Dessa forma, caso aconteça, ele será repassado para a próxima sprint, visto que os requisitos possuirão uma ordem de prioridade.
