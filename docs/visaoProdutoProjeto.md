...
| ----- | ----------- | ----------- | ------------- |
Desenvolvedores | Codificar o produto, codificar testes unitários, realizar refatoração || Emerson, Mateus Almeida, Caio Berg, Lucas de  Padua, Thalis, Pedro Lucas, Fellipe Pereira. |
Tech Lead | Atualizar o escopo do produto, organizar o escopo das sprints, validar as entregas | Emerson |Emerson, Mateus Almeida, Caio Berg, Lucas de Padua, Thalis, Pedro Lucas, Fellipe Pereira.
Scrum/Product Owner | Garantir a qualidade do produto, garantir o cumprimento do conceito de pronto, realizar inspeções de código | Cristian Furtado | Fellipe Pereira, Cristian Furtado, Rodrigo Santos, Valderson Junior, Victor Matheus.
Analista de requisitos | Garantir a qualidade e clareza  dos requisitos, realizar sua documentação, elicitação, verificação/validação gerência e negociação. | Rodrigo Santos | Fellipe Pereira, Cristian Furtado, Rodrigo Santos, Valderson Junior, Victor Matheus.
...
| Descrição | Causa | Objetivo | Replanejamento |
| --------- | ----- | -------- | -------------- |
...
- Scrum/Kanban
- Analise e design, análise dos requisitos
- Scrum com kanban
- Analise e design:
	- Analise dos requisitos
	- Prototipacao de interface do usuario
	- Design do banco de dados
	- Revisão de interface do usuario
- Implementação:
...
| --------- | ------ | ---------- | ------- |
| Priorizar todas as necessidades do usuário e ter domínio das informações de sistema. Assim resolvendo o problema do cliente. E compreender os requisitos | Abordagem com o cliente em entrevista | Entrevista no google meets | Lista de requisitos encaminhados para análise. |

### 4.2 Análise de Requisitos

| Atividade | Método | Ferramenta | Entrega |
| --------- | ------ | ---------- | ------- |
| Análise do problema e dos requisitos e verificar sua viabilidade para a implementação | Reunião com a equipe para saber as limitações de implementação dos requisitos | Discord | Lista de requisitos analisados e prontos para serem documentados. O refinamento de requisitos será abordado durante todo o projeto |

### 4.3 Documentação de Requisitos

| Atividade | Método | Ferramenta | Entrega |
| --------- | ------ | ---------- | ------- |
| Documentação de requisitos que foram acordados entre a equipe e o cliente | Registro deste em um documento disponível na internet | GitHub Pages, Google Docs, Atas de reuniões | Lista de requisitos documentados e seus tipos (não funcional e funcional), o Backlog do projeto |

### 4.4 Verificação e Validação de Requisitos

| Atividade | Método | Ferramenta | Entrega |
| --------- | ------ | ---------- | ------- |
| Verificação se os requisitos fazem parte da solução encontrada pelas partes envolvidas no projeto | Reunião com a equipe toda e com o cliente | Google Meets | Atualização do Backlog do produto |

### 4.5 Gerenciamento de Requisitos 

| Atividade | Método | Ferramenta | Entrega |
| --------- | ------ | ---------- | ------- |
| Permitir maior rastreabilidade de requisitos | Etiquetação de cada requisito por números e nomes | Trello, Discord, Telegram | Requisitos nomeados e priorizados, facilitados para gerenciamento |
...
| 28/06/2022 | 1.1.1  | Preenche campos indicados com dúvida | Christian Furtado, Fellipe Pereira |
| 29/06/2022 | 1.2    | Adicionado documento à Github Pages | Rodrigo Santos
| 29/06/2022 | 1.3    | Revisão do Documento de Visão Geral do Produto e Projeto | Christian Furtado, Fellipe Pereira, Rodrigo Santos, Valderson Junior